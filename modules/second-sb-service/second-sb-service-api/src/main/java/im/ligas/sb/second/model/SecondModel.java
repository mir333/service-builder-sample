...
/**
 * The base model interface for the Second service. Represents a row in the &quot;FOO_Second&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link im.ligas.sb.second.model.impl.SecondModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link im.ligas.sb.second.model.impl.SecondImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface SecondModel extends BaseModel<Second>, GroupedModel,
	ShardedModel, StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a second model instance should use the {@link Second} interface instead.
	 */
	...
	@Override
	public CacheModel<im.ligas.sb.second.model.Second> toCacheModel();
