...
/**
 * Provides the local service interface for Second. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SecondLocalServiceUtil
...
public interface SecondLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SecondLocalServiceUtil} to access the second local service. Add custom service methods to {@link im.ligas.sb.second.service.impl.SecondLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Second fetchSecondByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Second getSecondByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Second> getSecondsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
