...
/**
 * The base model interface for the First service. Represents a row in the &quot;FOO_First&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link im.ligas.sb.first.model.impl.FirstModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link im.ligas.sb.first.model.impl.FirstImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface FirstModel extends BaseModel<First>, GroupedModel, ShardedModel,
	StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a first model instance should use the {@link First} interface instead.
	 */
	...
	@Override
	public CacheModel<im.ligas.sb.first.model.First> toCacheModel();
